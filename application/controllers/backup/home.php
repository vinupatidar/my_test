...
class Home extends CI_Controller {
	...
	/*public function user_profile()
	{
		...
		//echo '<pre>'; print_r($data['user_data']); exit;
                $data['profile_count'] = $this->count_views($data['user_data'][0]->profile_count);
	...
	{
            $data['site_url_path'] = site_url($id_story.'/'.$title);
	...
	public function similar_feed($id)
	{
            $data['similar_stories'] = $this->home_model->get_similar_stories($id);
